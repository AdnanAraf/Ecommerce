...
const Navbar = () => {
  ...
  return (
    <div className="sticky top-0 z-50 ">
      <div className=" lg:flex  justify-between lg:h-[60px] h-[100px] bg-gray-800 gap-[200px] mt-[-60px] ">
        ...
        <Link to="Shop">
          <button className="bg-white lg:mr-[100px] ml-[30px] h-[30px] w-[120px] rounded-lg lg:mt-[15px] lg:relative absolute mt-[10px] ">
            Shop Now
          </button>
        </Link>
      </div>
      <div>
        <div className="lg:flex lg:justify-between bg-black  h-[80px]  ">
          <div className="flex justify-between">
            <div className="bg-gray-700 w-[250px] h-[50px] lg:ml-[50px] mt-[30px] rounded-t-lg">
            ...
            <div className="dropdown dropdown-bottom dropdown-end lg:hidden  block mr-[10px] mt-[-5px]">
              <label tabIndex={0} className=" m-1">
                <FaBars className="h-[30px] w-[20px] text-white mt-[20px]   "></FaBars>
              </label>
              <ul
                tabIndex={0}
